...
htmlhelp_basename = "EuroScipytutorialdoc"
...
latex_documents = [
    (
        master_doc,
        "EuroScipytutorial.tex",
        "EuroScipy tutorial Documentation",
        "Tania Allard",
        "manual",
    )
]
...
man_pages = [
    (master_doc, "euroscipytutorial", "EuroScipy tutorial Documentation", [author], 1)
]
